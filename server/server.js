...
var options = {
    ...
    appName: argv.n || process.env.SOCKETCLUSTER_APP_NAME || 'MyWebsocketApp',
...
var filesReadyPromises = [startWhenFileIsReady(workerControllerPath), startWhenFileIsReady(brokerControllerPath), startWhenFileIsReady(workerClusterControllerPath)];
